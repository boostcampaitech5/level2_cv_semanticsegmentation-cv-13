...
def run(args):
    ...
    trainloader = create_dataloader(dataset=trainset, batch_size=args.batch_size, shuffle=True,num_workers=4)
    valloader = create_dataloader(dataset=valset, batch_size=args.batch_size, shuffle=False,num_workers=4)
